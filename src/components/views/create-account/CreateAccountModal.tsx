...
export function CreateAccountForm({ isOpen, onClose, onSubmitStatus, isLoading, setIsLoading }: CreateAccountFormProps) {
  ...
  const onFinish = async (values: CreateAccountFormFields) => {
    try {
      ...
      onSubmitStatus(false, error instanceof Error ? error.message : "Failed to create account");
    }
  };
